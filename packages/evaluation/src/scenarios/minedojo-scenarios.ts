...
export const toolCraftingScenarios: Scenario[] = [
  {
    ...
    description:
      'Progress from wooden tools to stone tools through mining and crafting',
    domain: 'resource',
    complexity: 'advanced',
...

  {
    ...
    description:
      'Advance to iron tools by mining, smelting, and advanced crafting',
    domain: 'resource',
    complexity: 'expert',
...
export const buildingScenarios: Scenario[] = [
  {
    ...
    description:
      'Build a functional house with multiple rooms, doors, windows, and furniture',
    domain: 'spatial',
    complexity: 'advanced',
...

  {
    ...
    description:
      'Build an automated farm using redstone circuits and mechanisms',
    domain: 'logical',
    complexity: 'expert',
...
export const explorationScenarios: Scenario[] = [
  {
    ...
    description:
      'Explore a cave system, map the layout, and return with valuable resources',
    domain: 'spatial',
    complexity: 'advanced',
    expectedDuration: 180000,
...

  {
    ...
    description:
      'Build a nether portal, explore the nether, and return with nether resources',
    domain: 'hybrid',
    complexity: 'expert',
...
export const multiplayerScenarios: Scenario[] = [
  {
    ...
    description:
      'Coordinate with 3 other agents to build a large castle with specialized roles',
    domain: 'social',
    complexity: 'expert',
...
export const creativeScenarios: Scenario[] = [
  {
    ...
    description:
      'Create a recognizable pixel art image using colored blocks in a 32x32 grid',
    domain: 'creative',
    complexity: 'advanced',
    expectedDuration: 300000,
...

  {
    ...
    description:
      'Build a functional calculator using redstone that can perform basic arithmetic',
    domain: 'logical',
    complexity: 'emergent',
 ...
 */
export const minedojoScenariosByComplexity: Record<
  ComplexityLevel,
  Scenario[]
> = {
  basic: allMinedojoScenarios.filter((s) => s.complexity === 'basic'),
  intermediate: allMinedojoScenarios.filter(
...
export const minedojoScenariosByDomain: Record<ReasoningDomain, Scenario[]> = {
  ...
  meta_cognitive: allMinedojoScenarios.filter(
    (s) => s.domain === 'meta_cognitive'
  ),
...
export const MINEDOJO_METADATA = {
  ...
  domainDistribution: Object.fromEntries(
    Object.entries(minedojoScenariosByDomain).map(([domain, scenarios]) => [
      domain,
      scenarios.length,
    ])
  ),
  averageDifficulty:
    allMinedojoScenarios.reduce((sum, s) => sum + s.difficulty, 0) /
    allMinedojoScenarios.length,
  totalEstimatedDuration: allMinedojoScenarios.reduce(
