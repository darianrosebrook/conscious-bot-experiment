...
const validatePerformanceMetrics = (data) => exports.PerformanceMetricsSchema.parse(data);
exports.validatePerformanceMetrics = validatePerformanceMetrics;
const validateTrackingSession = (data) => exports.TrackingSessionSchema.parse(data);
exports.validateTrackingSession = validateTrackingSession;
const validateBudgetAllocation = (data) => exports.BudgetAllocationSchema.parse(data);
exports.validateBudgetAllocation = validateBudgetAllocation;
const validateRealTimeConfig = (data) => exports.RealTimeConfigSchema.parse(data);
