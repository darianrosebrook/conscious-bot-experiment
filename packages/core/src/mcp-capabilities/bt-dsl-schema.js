 ...
 */
export function isBTNode(node) {
    return node && typeof node.type === 'string';
}
/**
 * Type guard for SequenceNode
 */
export function isSequenceNode(node) {
 ...
 */
export function isFailOnTrueDecoratorNode(node) {
 ...
 */
export function isSensorPredicate(predicate) {
 ...
 */
export function getSensorPredicates(node) {
    const predicates = [];
 ...
 */
export function validateBTDSL(node) {
    const errors = [];
