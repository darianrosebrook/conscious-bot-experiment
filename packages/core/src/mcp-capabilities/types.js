...
var validateCapabilitySpec = function (data) {
    return exports.CapabilitySpecSchema.parse(data);
};
exports.validateCapabilitySpec = validateCapabilitySpec;
var validateExecutionRequest = function (data) {
    return exports.ExecutionRequestSchema.parse(data);
};
exports.validateExecutionRequest = validateExecutionRequest;
var validateExecutionContext = function (data) {
    return exports.ExecutionContextSchema.parse(data);
};
exports.validateExecutionContext = validateExecutionContext;
var validateMCPConfig = function (data) {
    return exports.MCPConfigSchema.parse(data);
};
