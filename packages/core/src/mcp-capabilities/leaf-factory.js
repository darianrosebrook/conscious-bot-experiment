...
import { validateLeafImpl, createExecError, verifyPostconditions, } from './leaf-contracts';
/**
    ...
    async run(name, version, ctx, args, opts) {
        ...
        try {
            ...
            if (res.status === 'success' && leaf.spec.postconditions && beforeState) {
                ...
                const postconditionResult = await verifyPostconditions(leaf.spec.postconditions, beforeState, afterState, this.ajv);
