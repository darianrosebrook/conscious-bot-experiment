 ...
 */
class BaseMinecraftExecutor {
    estimateCost(request, context) {
...
class PlaceBlockValidator extends BaseMinecraftValidator {
    async validatePreconditions(request, context) {
        ...
        const hasItem = context.inventory.some((item) => item.item === blockType && item.quantity > 0);
...
//# sourceMappingURL=capability-specs.js.map