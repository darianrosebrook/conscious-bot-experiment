...
var leaf_factory_js_1 = require("./leaf-factory.js");
...
var EnhancedRegistry = /** @class */ (function () {
    function EnhancedRegistry() {
        ...
        this.leafFactory = new leaf_factory_js_1.LeafFactory();
     ...
     */
    EnhancedRegistry.prototype.populateLeafFactory = function (leaves) {
        for (var _i = 0, leaves_1 = leaves; _i < leaves_1.length; _i++) {
            var leaf = leaves_1[_i];
            var result = this.leafFactory.register(leaf);
            if (!result.ok) {
                console.warn("Failed to register leaf ".concat(leaf.spec.name, ": ").concat(result.error));
            }
        }
    };
    /**
     ...
     * Get a leaf by ID
     */
    EnhancedRegistry.prototype.getLeaf = function (leafId) {
                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        execErr = error_1 && typeof error_1 === 'object' && 'code' in error_1
                            ? error_1
                            : (0, leaf_contracts_js_1.createExecError)({
                                code: 'unknown',
     ...
     */
    EnhancedRegistry.prototype.listLeaves = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Access the leaf factory to get registered leaves
                return [2 /*return*/, this.leafFactory.listLeaves()];
            });
        });
    };
    /**
    ...
    EnhancedRegistry.prototype.getStatistics = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                successfulShadowRuns = Array.from(this.shadowRuns.values()).reduce(function (sum, runs) { return sum + runs.filter(function (r) { return r.status === 'success'; }).length; }, 0);
                return [2 /*return*/, {
