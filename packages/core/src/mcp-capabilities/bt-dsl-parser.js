...
var bt_dsl_schema_js_1 = require("./bt-dsl-schema.js");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                status: 'failure',
                                error: (0, leaf_contracts_js_1.createExecError)(error_1),
                                metrics: {
                                    durationMs: node_perf_hooks_1.performance.now() - startTime,
                                    nodeExecutions: 1,
                                    leafExecutions: 1,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                status: 'failure',
                                error: (0, leaf_contracts_js_1.createExecError)(error_2),
                                metrics: {
                                    durationMs: node_perf_hooks_1.performance.now() - startTime,
                                    nodeExecutions: 1,
                                    leafExecutions: 0,
...
var BTDSLParser = /** @class */ (function () {
    function BTDSLParser() {
        ...
        this.validate = this.ajv.compile(bt_dsl_schema_js_1.BT_DSL_SCHEMA);
    ...
    BTDSLParser.prototype.parse = function (btDslJson, leafFactory) {
        ...
        var validation = (0, bt_dsl_schema_js_1.validateBTDSL)(btDslJson.root);
        if (!validation.valid) {
            return {
                valid: false,
        ...
        var leafNames = (0, bt_dsl_schema_js_1.getLeafNames)(btDslJson.root);
    ...
    BTDSLParser.prototype.compileNode = function (node, leafFactory) {
        var _this = this;
        if ((0, bt_dsl_schema_js_1.isLeafNode)(node)) {
            return new CompiledLeafNode(node, leafFactory);
        }
        else if ((0, bt_dsl_schema_js_1.isSequenceNode)(node)) {
            var children = node.children.map(function (child) {
                return _this.compileNode(child, leafFactory);
            });
            return new CompiledSequenceNode(node, children);
        }
        else if ((0, bt_dsl_schema_js_1.isSelectorNode)(node)) {
            var children = node.children.map(function (child) {
                return _this.compileNode(child, leafFactory);
            });
            return new CompiledSelectorNode(node, children);
        }
        else if ((0, bt_dsl_schema_js_1.isRepeatUntilNode)(node)) {
        ...
        else if ((0, bt_dsl_schema_js_1.isTimeoutDecoratorNode)(node)) {
            var child = this.compileNode(node.child, leafFactory);
            return new CompiledTimeoutDecoratorNode(node, child);
        }
        else if ((0, bt_dsl_schema_js_1.isFailOnTrueDecoratorNode)(node)) {
            var child = this.compileNode(node.child, leafFactory);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                status: 'failure',
                                error: (0, leaf_contracts_js_1.createExecError)(error_3),
                                metrics: {
                                    durationMs: node_perf_hooks_1.performance.now() - startTime,
                                    nodeExecutions: ctx.nodeExecutions,
                                    leafExecutions: ctx.leafExecutions,
