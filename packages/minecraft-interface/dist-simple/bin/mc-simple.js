...
async function main() {
  try {
    ...
    const config = {
      ...
      port:
        options.port !== undefined
          ? options.port
          : standalone_simple_1.DEFAULT_SIMPLE_CONFIG.port,
      username:
        options.username ?? standalone_simple_1.DEFAULT_SIMPLE_CONFIG.username,
    };
    if (options.verbose) {
    ...
    // Create interface
    const minecraftInterface = (0,
    standalone_simple_1.createSimpleMinecraftInterface)(config);
    // Connect to server
