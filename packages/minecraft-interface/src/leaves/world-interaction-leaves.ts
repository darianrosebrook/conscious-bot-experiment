...
// --- BuildStructureLeaf REMOVED ---
// Legacy class replaced by modular building system (build_module + prepare_site + place_feature).
// Goal type 'build_structure' is retained for intent routing (cognitive-task-handler, task-integration).
