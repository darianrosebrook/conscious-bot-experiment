...
import { createMinecraftInterface, runMinecraftScenario } from '../src/index';
import {
  createDefaultBotConfig,
  validateBotConfig,
  parseBotConfigFromArgs,
  formatTelemetryOutput,
...
Bot Configuration:
  ...
  --version <version>   Minecraft version (default: 1.21.9)
