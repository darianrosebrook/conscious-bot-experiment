 ...
 */
import { createSimpleMinecraftInterface, DEFAULT_SIMPLE_CONFIG, } from '../src/standalone-simple';
function parseArgs() {
...
async function main() {
    try {
        ...
        const config = {
            ...
            port: options.port !== undefined ? options.port : DEFAULT_SIMPLE_CONFIG.port,
...
//# sourceMappingURL=mc-simple.js.map