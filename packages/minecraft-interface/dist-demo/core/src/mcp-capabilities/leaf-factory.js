                ...
                switch (_g.label) {
                    ...
                    case 8:
                        afterState = (_c.snapshot = _g.sent(),
                            _c);
                        return [4 /*yield*/, (0, leaf_contracts_1.verifyPostconditions)(leaf.spec.postconditions, beforeState, afterState, this.ajv)];
                    case 9:
                    ...
                    case 11:
                        ...
                        return [2 /*return*/, {
                                status: 'failure',
                                error: (0, leaf_contracts_1.createExecError)(e_1),
                            }];
